...
export const Message = defineMessageUnion({
  ...
  SelectedEntityTypeScope: { scope: Schema.Literals(["all", "managed", "runtime"]) },
  ...
  RequestedEditEntity: {},
  RequestedEditEntityById: { entityId: Schema.String },
  ClosedEntityEditor: {},
  ...
  SelectedEntityEditorFormat: { format: Schema.Literals(["form", "json", "diff"]) },
